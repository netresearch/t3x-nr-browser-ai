...
SUBTITLE = {
    "en": "On-device answers about one page — no chat endpoint, no API key",
    "de": "On-Device-Antworten zu einer Seite – keine Chat-Schnittstelle, kein API-Schlüssel",
}
...
def main() -> None:
    for lang in ("en", "de"):
        ...
        target = HERE / f"og-browser-ai-{lang}.png"
        cairosvg.svg2png(
